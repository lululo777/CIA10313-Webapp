                    ...
                    <tbody>
                     <c:forEach var="product" items="${list}">
                        <tr class="tbody">
                            ...
                            <td class="quantity" name="quantity">${product.available_quantity}</td>
                           
                            <td class="status" name="status">${product.status==1 ? '已上架':'已下架'} </td>
                        
                            <td>${product.listed_time}</td>
                            <td><img src="${pageContext.request.contextPath}/ProductServlet?action=getone_Pic&prod_no=${product.prod_no}" alt="未上傳圖片" style="width:180px;height:180px" class="photo" name="photo"></td>
                            ...
                            <td><button type="button" name="action" value="delete" class="btn delete">刪除</button></td>
